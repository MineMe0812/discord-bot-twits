 ...
 */
export const getHashTags = (category: string, count: number, isTicker: boolean) => {
  
  if(isTicker && count > 0) count = count - 1;
  ...
  // If symbol is in futures, add ticker hashtag
  randomHashtags.push("#<ticker>_F");
